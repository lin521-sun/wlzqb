...
import { ENUM_ENEMY_STATUS } from "./Enum";
//关卡数据
export const Levels = [
    {
    ...
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, angle: 0, red: [
                { x: 50, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 250, isDirX: true }
            ]
        },
        cameraMove: { x: false, y: false },
        isTip: false
        ...
        blue: [
            ...
            },
            {
                x: 200, y: 250, angle: 180, status: ENUM_PLAYER_STATUS.IDLE, red: [
                    { x: 200, y: 350, angle: 90, status: ENUM_ENEMY_STATUS.ROUND, speed: 200, circleRadius: 100 },
                ]
            },
            {
                x: -200, y: 250, angle: 0, status: ENUM_PLAYER_STATUS.IDLE, red: [
                    { x: -200, y: 150, angle: 90, status: ENUM_ENEMY_STATUS.ROUND, speed: 200, circleRadius: 100 },
                ]
            }
        ],
        endpoint: {
            x: 0, y: 555, angle: 0, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 250, isDirX: true }
            ]
        },
        cameraMove: { x: false, y: false },
        isTip: false
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, angle: 0, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 400, distance: 150, isDirX: true }
            ]
        },
        cameraMove: { x: false, y: false },
        isTip: false
    ...
    },
    {
        ...
        blue: [
            { x: -150, y: -250, angle: 315, status: ENUM_PLAYER_STATUS.READY, red: [] },
            {
                x: 0, y: -400, angle: 90, status: ENUM_PLAYER_STATUS.IDLE, red: [
                    { x: 0, y: -400, angle: 180, status: ENUM_ENEMY_STATUS.ROUND, speed: 200, circleRadius: 100 }
                ]
            },
            { x: 150, y: -250, angle: 180, status: ENUM_PLAYER_STATUS.IDLE, red: [] },
            {
                x: 0, y: -100, angle: 270, status: ENUM_PLAYER_STATUS.IDLE, red: [
                    { x: 0, y: -400, angle: 180, status: ENUM_ENEMY_STATUS.ROUND, speed: 200, circleRadius: 100 }
                ]
            },
            {
                x: 0, y: 100, angle: 270, status: ENUM_PLAYER_STATUS.IDLE, red: [
                    { x: 0, y: 200, angle: 270, status: ENUM_ENEMY_STATUS.IDLE },
                    { x: 0, y: 250, angle: 270, status: ENUM_ENEMY_STATUS.IDLE },
                    { x: 0, y: 300, angle: 270, status: ENUM_ENEMY_STATUS.IDLE },
                    { x: 0, y: 350, angle: 270, status: ENUM_ENEMY_STATUS.IDLE },
                    { x: 0, y: 400, angle: 270, status: ENUM_ENEMY_STATUS.IDLE },
                    { x: 0, y: 450, angle: 270, status: ENUM_ENEMY_STATUS.IDLE },
                ]
            },
        ],
        endpoint: {
    ...
    },
    {
        ...
        blue: [
            {
                x: -200, y: 150, angle: 0, status: ENUM_PLAYER_STATUS.READY, red: [
                    { x: 0, y: 150, angle: 180, status: ENUM_ENEMY_STATUS.MOVE, speed: 400, distance: 150, isDirX: false }
                ]
            },
            { x: 220, y: 150, angle: 180, status: ENUM_PLAYER_STATUS.IDLE, red: [] },
            {
                x: -200, y: -150, angle: 0, status: ENUM_PLAYER_STATUS.IDLE, red: [
                    { x: 0, y: -150, angle: 0, status: ENUM_ENEMY_STATUS.MOVE, speed: 400, distance: 120, isDirX: false }
                ]
            },
            { x: 200, y: -150, angle: 180, status: ENUM_PLAYER_STATUS.IDLE, red: [] },
            {
                x: 0, y: -400, angle: 90, status: ENUM_PLAYER_STATUS.IDLE, red: []
            },
        ],
    ...
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, angle: 0, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 150, isDirX: true },
            ]
        },
        cameraMove: { x: false, y: false },
        isTip: false
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, angle: 0, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 420, distance: 150, isDirX: true },
            ]
        },
        cameraMove: { x: false, y: false },
        isTip: false
    ...
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, width: 200, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 120, isDirX: true }
            ]
        },
        cameraMove: { x: true, y: false },
        isTip: false
    },
    {
        ...
        blue: [
            { x: 0, y: -200, angle: 90, status: ENUM_PLAYER_STATUS.READY, red: [] },
            {
                x: 0, y: 150, angle: 270, status: ENUM_PLAYER_STATUS.IDLE, red: [
                    { x: 0, y: 250, angle: 270, status: ENUM_ENEMY_STATUS.MOVE, speed: 200, distance: 150, isDirX: true },
                    { x: 0, y: 50, angle: 270, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 150, isDirX: true },
                    { x: 0, y: 150, angle: 270, status: ENUM_ENEMY_STATUS.ROUND, speed: 200, circleRadius: 100 }
                ]
            },
        ],
        endpoint: {
    ...
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, width: 200, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 140, isDirX: true },
                { x: 0, y: 355, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 400, distance: 120, isDirX: true }
            ]
        },
        cameraMove: { x: true, y: false },
        isTip: false
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, width: 200, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.IDLE, speed: 500, distance: 120, isDirX: true }
            ]
        },
        cameraMove: { x: true, y: false },
        isTip: false
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, width: 200, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 200, isDirX: true },
                { x: 0, y: 355, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 400, distance: 150, isDirX: true }
            ]
        },
        cameraMove: { x: false, y: true },
        isTip: false
    ...
    },
    {
        ...
        blue: [
            ...
            { x: -200, y: 0, angle: 0, status: ENUM_PLAYER_STATUS.IDLE, red: [] },
            {
                x: 0, y: -150, angle: 90, status: ENUM_PLAYER_STATUS.IDLE, red: [
                    { x: -100, y: 400, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 150, isDirX: true },
                    { x: -50, y: 400, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 150, isDirX: true },
    ...
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, width: 200, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 200, isDirX: true },
                { x: -100, y: 355, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 500, distance: 180, isDirX: true }
            ]
        },
        cameraMove: { x: true, y: false },
        isTip: false
    },
    {
        ...
        endpoint: {
            x: 0, y: 555, width: 200, red: [
                { x: 0, y: 455, angle: 90, status: ENUM_ENEMY_STATUS.MOVE, speed: 400, distance: 120, isDirX: true }
            ]
        },
        cameraMove: { x: true, y: false },
        isTip: false
